...
public float shiftRate = 10.0f;// 按住Shift加速  
...
// 获取按键输入  
if (Input.GetKey(KeyCode.Y)) speedForward = tourCamera.forward;  
if (Input.GetKey(KeyCode.H)) speedBack = -tourCamera.forward;  
if (Input.GetKey(KeyCode.G)) speedLeft = -tourCamera.right;  
if (Input.GetKey(KeyCode.J)) speedRight = tourCamera.right;  
if (Input.GetKey(KeyCode.T)) speedUp = Vector3.up;  
if (Input.GetKey(KeyCode.U)) speedDown = Vector3.down;  
